...
- [`2026-04-15-json-export/`](2026-04-15-json-export/README.md) — *Add `--json` / `--ndjson` output modes to every read-only helio subcommand so downstream tools can consume structured results without parsing terminal output.* `[project, later, helio, output, json]`
