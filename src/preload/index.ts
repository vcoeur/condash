...
const api: CondashApi = {
  ...
  listReposForPrimary: (primaryPath) => ipcRenderer.invoke('listReposForPrimary', primaryPath),
  ...
  getWelcomeInitShown: () => ipcRenderer.invoke('getWelcomeInitShown'),
  setWelcomeInitShown: (value) => ipcRenderer.invoke('setWelcomeInitShown', value),
  ...
  createProjectFile: (projectPath, dirRelPath, name) =>
    ipcRenderer.invoke('createProjectFile', projectPath, dirRelPath, name),
  createProjectDir: (projectPath, dirRelPath, name) =>
