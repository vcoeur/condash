...
const api: CondashApi = {
  ...
  readAgent: (slug) => ipcRenderer.invoke('readAgent', slug),
  writeAgent: (def, previousSlug) => ipcRenderer.invoke('writeAgent', def, previousSlug),
  deleteAgent: (slug) => ipcRenderer.invoke('deleteAgent', slug),
  previewAgent: (slug) => ipcRenderer.invoke('previewAgent', slug),
  readAgentsEnv: () => ipcRenderer.invoke('readAgentsEnv'),
  writeAgentsEnv: (content) => ipcRenderer.invoke('writeAgentsEnv', content),
