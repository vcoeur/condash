...
describe('parseReadmesWithDiskCache', () => {
  ...
  it('pins the persisted {project, header} shape to PARSE_CACHE_VERSION (F2 drift guard)', async () => {
    ...
    const EXPECTED =
      '{"header":{"apps":["string"],"base":"string","branch":"string","date":"string","extra":{},"kind":"string","status":"string","title":"string"},"project":{"apps":["string"],"base":"string","branch":"string","closedAt":"string","deliverableCount":"number","deliverables":[{"description":"string","kind":"string","label":"string","path":"string"}],"kind":"string","lastActivity":"string","path":"string","slug":"string","status":"string","stepCounts":{"blocked":"number","doing":"number","done":"number","dropped":"number","todo":"number"},"steps":[{"lineIndex":"number","marker":"string","section":"string","text":"string"}],"summary":"string","timeline":[{"date":"string","text":"string"}],"title":"string"}}';
