...
Add a body file only when the first non-pointer fact surfaces (sandbox recipe, cross-project gotcha, rename history, invariant to preserve). Until then, the row in this index *is* the body.

## Apps

_No app rows yet. Add one as `<app>` → short description._
