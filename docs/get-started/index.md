...
- **Code** (right pane) — your repos, dirty status, open-in-IDE buttons. Empty until you set `workspace_path` and `repositories` in `configuration.json` (Settings → **Workspace** + **Repositories**).
