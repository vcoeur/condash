...
![The condash dashboard: a Projects pane grouping items under NOW, REVIEW, LATER, BACKLOG and DONE, and a Code pane listing three top-level git repos with their branches](assets/screenshots/dashboard-overview-light.png#only-light)
![The condash dashboard: a Projects pane grouping items under NOW, REVIEW, LATER, BACKLOG and DONE, and a Code pane listing three top-level git repos with their branches](assets/screenshots/dashboard-overview-dark.png#only-dark)
