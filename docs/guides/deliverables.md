...
| `.mdx` | the in-app visual-note viewer — typed blocks (wireframes, diffs, data models, …) with a **Rendered / Source** toggle; see the [visual notes guide](plan-documents.md) |
