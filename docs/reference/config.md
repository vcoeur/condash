...
| `{"name": "repo", "install": "<cmd>"}`                    | Install command run after `condash worktrees setup` creates a worktree, gated by the `--install` CLI flag. Typical: `npm install` for a Node repo, `pip install -e .` for a Python one. Same shell trust level as `run`.                                                                                                                                                                                                                                                                                  |
